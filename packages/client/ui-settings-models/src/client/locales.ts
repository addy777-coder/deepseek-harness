...
export const en = {
  ...
  networkVpn: 'Built-in VPN',
  networkVpnHint: 'VPN requires a configured VPN connection, an API key, and the Anthropic Messages protocol. Requests stop if the VPN is unavailable.',
  networkSaveBeforeFetch: 'Save the provider connection settings before fetching models through VPN.',
  models: 'Models',
  ...
  visionTag: 'Vision',
  recognitionTitle: 'Image recognition',
  recognitionDescription: 'When the conversation model accepts text only, this model receives images and supplies a factual report. Images are sent to its provider.',
  recognitionModel: 'Image recognition model',
  recognitionNone: 'Not configured',
  recognitionUnavailable: 'Unavailable',
  recognitionLoading: 'Loading image-capable models…',
  recognitionLoadFailed: 'Image-capable models could not be loaded.',
  recognitionPartial: 'Some providers could not be loaded; a saved unavailable selection remains removable.',
  recognitionInvalid: 'Choose an available model that supports image input, or clear the selection.',
  recognitionSaveFailed: 'The image recognition model could not be saved. Try again.',
  recognitionConflict: 'Settings changed elsewhere. Discard this selection and try again.',
  recognitionSave: 'Save image recognition model',
  recognitionSaving: 'Saving image recognition model…',
  recognitionProtected: 'This model is the saved image recognition model. Choose another image recognition model before removing it or disabling image input.',
  addModel: 'Add model',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  networkDirect: '直连',
  networkVpn: '内置 VPN',
  networkVpnHint: 'VPN 需要已配置的 VPN 连接、API 密钥和 Anthropic Messages 协议。VPN 不可用时会停止请求。',
  networkSaveBeforeFetch: '请先保存提供商的连接设置，再通过 VPN 获取模型。',
  models: '模型目录',
  ...
  visionTag: '视觉',
  recognitionTitle: '图片识别',
  recognitionDescription: '会话模型仅支持文本时，图片会发送给此模型，并将其事实描述提供给会话模型。图片会发送到该模型的提供方。',
  recognitionModel: '图片识别模型',
  recognitionNone: '未配置',
  recognitionUnavailable: '当前不可用',
  recognitionLoading: '正在加载支持图片的模型…',
  recognitionLoadFailed: '无法加载支持图片的模型。',
  recognitionPartial: '部分提供方暂时无法加载；已保存但不可用的选择仍可移除。',
  recognitionInvalid: '请选择当前可用且支持图片输入的模型，或清除选择。',
  recognitionSaveFailed: '无法保存图片识别模型，请重试。',
  recognitionConflict: '设置已在其他位置更新。请放弃当前选择后重试。',
  recognitionSave: '保存图片识别模型',
  recognitionSaving: '正在保存图片识别模型…',
  recognitionProtected: '该模型是当前已保存的图片识别模型。删除它或关闭图片能力前，请先选择其他图片识别模型。',
  addModel: '添加模型',
  removeModel: '删除模型',
