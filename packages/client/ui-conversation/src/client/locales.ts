...
export const zh = {
  ...
  'image.modelUnsupported': '当前模型不支持图片，请在“设置 → 模型”中配置图片识别模型，或切换到视觉模型',
  'image.recognitionUnavailable': '已配置的图片识别模型当前不可用，请在“设置 → 模型”中重新选择',
  'image.recognitionNotCapable': '已配置的图片识别模型未声明图片能力，请在“设置 → 模型”中重新选择',
...
export const en = {
  ...
  'image.modelUnsupported': 'The current model does not support images; configure an image recognition model in Settings > Models or switch to a vision model',
  'image.recognitionUnavailable': 'The configured image recognition model is unavailable; choose another in Settings > Models',
  'image.recognitionNotCapable': 'The configured image recognition model does not declare image input; choose another in Settings > Models',
