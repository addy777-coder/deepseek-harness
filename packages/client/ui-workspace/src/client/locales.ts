...
export const zh = {
  ...
  'section.deleteDescription': '删除“{name}”后，项目将移回默认区域，独立会话将回到所属项目或侧栏。文件和会话记录会保留。',
  'section.move': '移动到分区',
  ...
  'delete.desc': '将把“{name}”从工作区列表中移除。文件夹与会话记录会保留，其会话仍会显示在侧栏。',
...
export const en = {
  ...
  'section.deleteDescription': 'Deleting “{name}” moves its projects to the default area and returns independent sessions to their project or the sidebar. Files and session histories will be kept.',
  ...
  'delete.desc': 'This removes “{name}” from the workspace list. The folder and session logs will be kept, and its sessions stay listed in the sidebar.',
