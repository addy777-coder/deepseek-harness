...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-desktop DesktopPreferences id \'desktop-integration\'',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-desktop PluginManager id \'desktop-manage\'',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Optional desktop title bar rendered above the column frame.',
    doc: 'Optional desktop title bar rendered above the column frame.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-desktop DesktopTitleBar',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-desktop DesktopBrandMark',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-desktop DesktopBrandName',
    ],
    replaceRisk: 'shadows-shipped-ui',
