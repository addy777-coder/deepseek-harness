...
The selected `network/changed` notification carries the network service's redacted VPN view. Its credentials remain write-only through the VPN Controller; ordinary notifications do not carry profile text or passwords.
