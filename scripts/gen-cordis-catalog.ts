...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  webConnection: 'interface-typed Web adapter service — packages/client/connection/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ImageRecognitionBatch: 'llm-streaming.md',
  ImageRecognitionResult: 'llm-streaming.md',
  ImageRecognitionTarget: 'llm-streaming.md',
  InboxItem: 'core.md',
  ...
  SidebarSection: 'workspace.md',
  SidebarSectionId: 'workspace.md',
  SidebarSectionCreateRequest: 'workspace.md',
  SidebarSectionCreateValue: 'workspace.md',
  SidebarSectionRenameRequest: 'workspace.md',
  SidebarSectionRequest: 'workspace.md',
  SidebarSectionInsertBeforeRequest: 'workspace.md',
  WorkspaceSectionMoveRequest: 'workspace.md',
  SessionSectionMoveRequest: 'workspace.md',
  WorkspaceLayout: 'workspace.md',
  ...
  ClientBootInjectionProducer: 'client-modules.md',
  ClientModuleArtifact: 'client-modules.md',
