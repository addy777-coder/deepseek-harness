...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  usage: 'Client-only usage query state and commands are documented by packages/api/usage-controller/README.md',
  vpn: 'Client-only redacted VPN state and commands are documented by packages/api/vpn-controller/README.md',
